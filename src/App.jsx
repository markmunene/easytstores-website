  ...
  return (
    <div className="cotainer">
      <Navbar
        ...
        scrollDownContact={scrollDownContact}
        scrollDownFaq={scrollDownFaq}
      />
      <div className="hero-section">
        <div className="heroHeader">
          <h1>
            Easystores <br /> Application
          </h1>
        ...
        <div className="productImagesContainer">
          <img
            ...
            src={pic1}
          />
          <img className="img-fluid productImage" src={pic2} />
          <img
            className="img-fluid productImage"
            style={{
              marginTop: "50px",
      ...
      <div className="about-section">
        <div className="download-btn">
          <a
            href="https://play.google.com/store/apps/details?id=com.barebillingv3"
            role="button"
          >
            <img alt="" src={play} />
          </a>
      ...
      <div className="row">
        ...
        >
          <div className="col-md-6 photoContainer">
            <span>
              <strong>Updating stock screen</strong>
            </span>
          ...
          <div className="col-md-6">
            <div className="about-textContent">
              <div className="">
                <h2 className="">Monitoring product stock levels</h2>
                <p className="w-75">
                  The app allows the merchant to monitor stock levels of each
                  product. if a product is below the set minimum quantity the
                  merchant receives a whatsapp message of all the products
                  running low.
                </p>
      ...
      <div className=" row ">
        <div className="aboutSectionContent">
          <div className=" col-md-6 ">
            <div className="about-textContent">
              <h2 className="">Sales analysis</h2>
              <p className="w-75 classMleft ">
                Using the selling price and buying price the app calculates the
                profit for each product sold and the results are recorded for
                analysis with these records can be generated of each product
                sold in a particular date, month, year , to a certain cutomer
                etc.
              </p>
              <a href="" className="btn btn-primary shadow">
                {" "}
          ...
          <div className=" col-md-6 photoContainer">
            <span>
              <strong>Sales Analysis Screen</strong>
            </span>
      ...
      <div className="row">
        <div className="aboutSectionContent">
          <div className="col-md-6 photoContainer">
            <span>
              <strong>Saving a Sale screen</strong>
            </span>
          ...
          <div className="col-md-6">
            <div className="about-textContent">
              <div className="">
                <h2 className="">Printing reciepts using bluetooth printer</h2>
                <p className="w-75">
                  The app prints a receipt using a thermal printer conneted
                  through bluetooth. beside this it also calculates balance
                  automatically and also offer discounts to users. finally while
                  recording a sale a saler can capture the customer contact
                  which can later be used for marketting.
                </p>
                <a href="" className=" learn-more3 shadow">
                  {" "}
                  learn more
                </a>
              </div>
        ...
        <div className="faqs-content">
          <div className="faqs-content-item card mb-2 ">
            <div className=" card-header">
              <div className="item-Header">
                <button
                  ...
                  className="faq-open-btn mr-1"
                >
                  <i
                    className={
                      openFaq
                        ? "fa-sharp fa-solid fa-minus"
                        : "fa-solid fa-plus"
                    }
                  ></i>
                </button>
            ...
            <div className="item-content card-body " ref={faqContentRef}>
              <p>
                Press the low stock button on the home screen and it will filter
                out all the products with stock level below or equal current
                stock
              </p>
            </div>
          </div>
          <div className="faqs-content-item card mb-2">
            ...
            <div className="item-content card-body " ref={faqContentRef1}>
              <p>Press the sync button on the home screen</p>
            </div>
          </div>
          <div className="faqs-content-item card mb-2">
            <div className=" card-header">
              <div className="item-Header">
                ...
                <h3 className="mt-1 text-center">
                  Generate sales reports, income statement ?
                </h3>
              </div>
            </div>
            <div className="item-content card-body " ref={faqContentRef3}>
              <p>
                Go to admin screen the press the three dots on the to right
                corner and select sales report
              </p>
            </div>
          </div>
          <div className="faqs-content-item card mb-2">
            <div className=" card-header">
              <div className="item-Header">
                ...
                <h3 className="mt-1 text-center">
                  Record expenses, gains outside sales ?
                </h3>
              </div>
            </div>
            <div className="item-content card-body " ref={faqContentRef2}>
              <p>
                Go to items then income statement expenses then select either
                gain or lose , expense description and amount
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-6">
            <div className="download-text-content">
              <div className="">
                <h1>download App</h1>
                <p className="mb-4">
                  Ease your struggle for managing your shop and taking it to the
                  next level in life
                </p>
          ...
          <div className="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form method="post" role="form" className="php-email-form">
              ...
              <div className="mb-3">
                ...
                <div id="message_sent" className="sent-message">
